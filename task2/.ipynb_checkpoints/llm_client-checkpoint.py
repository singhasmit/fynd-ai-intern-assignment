...
# 1. Configure API key from environment
api_key = "AIzaSyDExWDFN2SbvAjN8X48X_46bNIHni4M-pE"
if api_key is None:
    raise ValueError("GEMINI_API_KEY environment variable not set.")

genai.configure(api_key=api_key)

# 2. Use a good free model
model = GenerativeModel("gemini-2.5-flash")  # or "gemini-2.5-flash" if it works for you
