...
st.write(
    ...
    "We’ll save it and generate AI responses later."
)
...
if st.button("submit review"):  #if button is clicked then this block gets executed
    if not review.strip():          #review is empty
        ...
        ai_response = f"Thank you for your {rating}-star review!"
        ai_summary = "AI summary will be generated here in the next step."
        ai_action = "AI recommended action will be added later."
